...
const navItems = [
  ...
  },
  {
    ...
    href: "/dashboard/clinical-options",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  },
  {
    ...
    href: "/dashboard/quick-responses",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-secondary text-white h-screen sticky top-0 flex flex-col overflow-y-auto hide-scrollbar">
      {/* Logo */}
